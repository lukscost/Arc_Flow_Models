...
% com e sem rotação para o caso restrito a um item por tipo
...
if hotrool == 1
disp('Modelo gerador de padrão de corte restrito e COM rotação de itens')
else
disp('Modelo gerador de padrão de corte restrito e SEM rotação de itens')
end
...
[x,fo,u,y] = cplexlp(-c,MDe,d,Ma,rhs,LB,UB,[],opt);
...
[xu,foi,u,yi] = cplexmilp(-c,MDe,d,Ma,rhs,[],[],[],LB,UB,type,[],opt);
