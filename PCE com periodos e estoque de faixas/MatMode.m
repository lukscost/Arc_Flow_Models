function [DE, U, Tt, gt, itTO, ft, I, o4, tew, cd, Dt,  Qtil, Ytil, idz, id1es, idzs , id2es] = MatMode(L,l,W,w,d)
...
% Matriz de armazenamento das faixas
Qtil = [zeros(lg,lu); eye(lu); zeros(lf+ld,lu)];
Ytil = [zeros(lg+lu+lf,ld); eye(ld)];
