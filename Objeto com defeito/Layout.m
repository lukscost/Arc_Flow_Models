...
% LAYOUT
% Mudar os custos para maximizar a quantidade de itens
...
switch i
    ...
    case 4
        ...
        PatK1 = [zv1 zv2 -2; PatK1 zeros(mt1,nk+1); zeros(mk,nt1) Tt zeros(mk,1)];
...
ortk = [jt obj(1,1) obj(2,1) obj(3,1)  obj(4,1) sum(obj)];
ort = [ort; ortk];
...
tit = ['Val. Utili. & area itens & despe PD & desp defeito & tmod & TCplex'];
